                ...
                <Toolbar>
                    ...
                    {user && (
                        <>
                            ...
                            <Link to={"/accept"}>don dang thue</Link> &emsp;
                            <Link to={"/pendingProvider"}>don thue CCDV</Link>&emsp
                            <Link to={"/acceptProvider"}>don dang thuc hien CCDV</Link>&emsp
                            <Link to={"/rejectProvider"}>don tu choi CCDV</Link>
                        </>
                    )}
